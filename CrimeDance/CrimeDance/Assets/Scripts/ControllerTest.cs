...
public class ControllerTest : MonoBehaviour {
    ...
    public enum ButtonType { U, UR, R, DR, D, DL, L, UL }
	...
	void Update () {
        ...
        if (GameController.instance.createMode)
        {
            ...
            {
                GameController.instance.noteTypeMode = Note.NoteType.golden;
                GameController.instance.createModeSign.color = Color.yellow;
            }
            if (Input.GetMouseButton(1))
            {
                GameController.instance.noteTypeMode = Note.NoteType.action;
                GameController.instance.createModeSign.color = Color.red;
            }
            if (Input.GetMouseButtonUp(1) || Input.GetMouseButtonUp(0))
            {
                GameController.instance.noteTypeMode = Note.NoteType.normal;
        ...
        if (Input.GetKeyDown(KeyCode.UpArrow))
        {
            if (GameController.instance.createMode)
            {
                GameController.instance.CreateNote(ButtonType.U);
        ...
        if (Input.GetKeyDown(KeyCode.DownArrow))
        {
            if (GameController.instance.createMode)
            {
                GameController.instance.CreateNote(ButtonType.D);
        ...
        if (Input.GetKeyDown(KeyCode.LeftArrow))
        {
            if (GameController.instance.createMode)
            {
                GameController.instance.CreateNote(ButtonType.L);
        ...
        if (Input.GetKeyDown(KeyCode.RightArrow))
        {
            if (GameController.instance.createMode)
            {
                GameController.instance.CreateNote(ButtonType.R);
